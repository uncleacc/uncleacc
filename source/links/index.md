...
layout: links
title: links
date: 2020-4-22 23:11:06
keywords: 友人帐
description: 
comments: true
photos: https://cdn.jsdelivr.net/gh/uncleacc/Img/custom/2.webp
links:
  - group: 个人项目
    desc: 我的仓库
    items: 
  ...
  - group: 我的哥哥们
    ...
    - url: http://www.ryuichi.tech/
      img: https://s1.ax1x.com/2020/05/10/Y1JcWt.jpg
      name: Ryuichi
      desc: Ryuichi的算法分享
  - group: 关于主题
    desc: 感谢主题开发者
    items:
    - url: https://2heng.xin/
      img: https://view2.2heng.xin/2018/03/27/avatar.jpg
      name: Mashiro
      desc: 樱花庄的白猫
  ...
  - group: 我的同学们
    desc: 一个比一个强😱
    items: 
    - url: https://www.maliaoblog.cn
      img: https://www.maliaoblog.cn/medias/logo.png
      name: 码里奥
      desc: 与技术成长，让自己看到改变
    - url: https://syl-cell.github.io
      img: https://syl-cell.github.io/images/avatar.gif
      name: un_dauant
      desc: 每个人都比自己想象的要强大
  - group: 小伙伴们
    desc: 欢迎交换友链 ꉂ(ˊᗜˋ)
    items:
    - url: https://cungudafa.gitee.io/
      img: https://cdn.jsdelivr.net/gh/cungudafa/cdn/img/custom/cungudafa.jpg
      name: cungudafa
      desc: 一个学习记录者
    - url: https://xiabor.com
      img: https://xiabor.com/img/avatar.png
      name: 雪曦
      desc: 君浅吟，叹落笔
    - url: https://bili33.top
      img: https://cdn.jsdelivr.net/gh/GamerNoTitle/Picture-repo@1.0/AboutMe/logo-mini.png
      name: GamerNoTitle
      desc: 一个在懵懂无知中成长的高中生程序员^V^
    - url: https://www.antmoe.com/
      img: https://cdn.jsdelivr.net/gh/sviptzk/HexoStaticFile@latest/avatar.jpg
      name: 小康博客
      desc: 一个收藏回忆与分享技术的地方！
    ...
    - url: https://www.hongmaple.xyz/
      img: https://www.hongmaple.xyz/img/friend_404.gif
      name: maple `s Blog
      desc: 用代码装饰生活
    - url: https://wallleap.gitee.io/blog/
